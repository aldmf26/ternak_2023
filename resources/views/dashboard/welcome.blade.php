        ...
        <div class="container-fluid">
                        ...
                        <div class="card-body">
                            <form action="{{ route('check_telur') }}" method="post">
                                ...
                                <button class="btn btn-md btn-costume float-right mt-3" type="submit"><i
                                        class="far fa-{{ empty($check) ? '' : $check == 'Y' ? 'times' : 'check' }}-circle"></i> {{  empty($check) ? '' : $check ==
                            ...
                            <form action="{{ route('check_telur') }}" method="post">
                                ...
                                <table class="table table-bordered table-sm table-responsive" style="font-size: 12px; ">
                                    ...
                                    <tr>
                                        ...
                                        $checkA = empty($stock->check) ? 0 : $stock->check;
                                        @endphp
                                        <input type="hidden" name="id_penjualan[]" value="{{ empty($stock->id_penjualan) ? '0' : $stock->id_penjualan }}">
                                        <input type="hidden" name="cek_alpa" value="{{ $checkA == 'Y' ? 'T' : 'Y' }}">
                                        <td>{{ $stock->pcs ?? 0 }}</td>
                                        <td>{{ number_format($stock->kg ?? 0,1) }}</td>
                                        <td>{{ number_format(empty($stock->pcs) ? 0 : $stock->pcs / 180 ?? 0,1) }}</td>
                                        <td>{{ number_format(empty($stock->pcs) ? 0 : $stock->kg - ($stock->pcs / 180) ?? 0,1) }}</td>
                                        @endforeach
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table width="100%" border="1" style="white-space: nowrap; ">
                                <thead>
                                    <tr>
                                        <th rowspan="2" style="background-color: #629779; color: #ffff; width:10%;">
                                        </th>
                                        @foreach ($jenisTelur as $j)
                                        <td style="background-color: #629779; color: #ffff; text-align:center;width:20%; font-weight: bold; font-family: Arial, Helvetica, sans-serif;"
                                    ...
                                    <tr>
                                        @foreach ($jenisTelur as $j)
                                        <th width="8%" style="background-color: #629779; color: #ffff; text-align: center;padding:10px ">Pcs
                                        </th>
                                        <th width="8%" style="background-color: #629779; color: #ffff; text-align: center;padding:10px">Kg
                                        </th>
                                        <th width="8%" style="background-color: #629779; color: #ffff; text-align: center;padding:10px">Ikat
                                        </th>
                                        @endforeach
                                ...
                                <tbody>
                                    <tr></tr>
                                    <tr>
                                        <td style="color: #787878; font-weight: bold;padding:10px; ">Stok Alpa</td>
                                        ...
                                        @endphp
                                        <td align="center" style="padding:10px;">{{ $sisa->pcs - $stok->pcs ?? 0 }}</td>
                                        <td align="center" style="padding:10px;">{{ number_format($sisa->kg - $stok->kg ?? 0, 1) }} </td>
                                    ...
                                    <tr></tr>
                                    <tr>
                                        <td style="color: #787878;font-weight: bold;padding:10px;">Stok martadah</td>
                                        @foreach ($jenisTelur as $j)
                                        @php
                                        $sisa = DB::selectOne("SELECT SUM(a.pcs) as pcs, SUM(a.kg) as kg FROM
                                        `tb_penjualan_telur` as a
                            ...
                            <table width="100%" style="white-space: nowrap; text-align: center; ">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="12.5%">
                                            {{ empty($cek) ? '' : $cek == 'Y' ? 0 : number_format($ayamPotong->culling, 0) }} Ekor
                                        </td>
                                        <td width="12.5%" style="border-right: 1px solid black;">
                                            <form action="{{ route('check_ayam_mtd') }}" method="post">
                                                @csrf
                                                <input type="hidden" name="check" value="{{ empty($cek) ? '' : $cek == 'Y' ? 'T' : 'Y' }}">
                                                @foreach ($ayam as $a)
                                                <input type="hidden" name="id_populasi" value="{{ $a->id_pop }}">
                                                <input type="hidden" name="tgl" value="{{ $tgl1 }}">
                                                @endforeach

                                                <button type="submit" class="btn btn-costume  btn-sm"><i
                                                        class="fas fa-{{ empty($cek) ? '' : $cek == 'Y' ? 'times' : 'check' }}-circle"></i>
                                                </button>
            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table" id="example1">
                                <thead style="background-color: #629779; color:#ffff;">
                                    <tr>
                                        <td>Nama Pakan</td>
                                        <td>Qty</td>
                                        <td>Satuan</td>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="float-left bekecil">Stok Obat dan Vitamin </h6>
